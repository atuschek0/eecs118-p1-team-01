# analysis.py
# -----------
# Based on analysis.py from the UC Berkeley Pacman AI Projects.
...
def question2a():
    ...
    #--------------------------
    # Catman here!
    # - To prefer the fastest route, choose a high discount factor
    # - To prefer avoiding risks, choose a positive noise value
    # - To encourage reaching the goal quickly, choose a small negative living reward
    #--------------------------
    answerDiscount = 0.3
    answerNoise = 0.0
